...
public class Connexion {
     ...
     *
     * @param nameDatabase nom de la databse
     * @param loginDatabase login de connexion
     * @param passwordDatabase mdp de connexion
     ...
     *
     * @param table string à ajouter à la table tables
     */
     ...
     * ArrayList
     *
     * @param requete string à ajouter à la table requete
     */
     ...
     * ArrayList
     *
     * @param requete string à ajouter a la table requetesmaj
     */
     ...
     *
     * @param table string permettant la requete sql
     * @return L'arraylist des champs de la table en parametre
     * @throws java.sql.SQLException exception
     */
     ...
     * @param requete string permettant la requete sql
     * @return  L'arraylist des champs de la requete en parametre
     * @throws java.sql.SQLException exception
     */
     ...
     * @param requeteMaj string permettant la requete sql
     * @throws java.sql.SQLException exception
     */
